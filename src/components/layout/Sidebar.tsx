...
const navGroups: { label?: string; items: NavItem[] }[] = [
  ...
  },
  {
    label: "Services",
    items: [
      { to: "/my-vms", icon: Monitor, label: "EC2" },
      { to: "/aws/s3", icon: Database, label: "S3", adminOnly: false },
      { to: "/aws/vpcs", icon: Network, label: "VPC", adminOnly: false },
      { to: "/aws/load-balancers", icon: Waypoints, label: "Load Balancers", adminOnly: false },
      { to: "/aws/route53", icon: Route, label: "Route 53", adminOnly: false },
      { to: "/aws/rds", icon: HardDrive, label: "RDS", adminOnly: false },
      { to: "/aws/eks", icon: Boxes, label: "EKS", adminOnly: false }
    ],
  },
  {

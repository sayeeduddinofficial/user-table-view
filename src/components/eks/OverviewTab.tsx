    ...
    <div className="space-y-4">
      <div className="bg-card border border-border rounded-lg p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5 text-sm">
          <Field label="API server endpoint" value={<CopyText text={CLUSTER.apiServerEndpoint} />} />
          <Field label="OpenID Connect provider URL" value={<CopyText text={CLUSTER.oidcProviderUrl} />} />
          ...
          <Field
            ...
            value={
              <span className="inline-flex items-start gap-1.5">
                ...
                <a className="text-primary hover:underline whitespace-nowrap" href="#">
                  View in IAM
                </a>
              </span>
            }
          ...
          <div className="space-y-5">
            <Field label="Cluster ARN" value={<CopyText text={CLUSTER.clusterArn} />} />
